...
Class Notificacion {
	...
	function Notificacion($conexion){ //Le paso 
	...
	*/
	function nuevoUsuario($id_destinatario,$id_remitente,$nombre){
		...
		$result = sqlsrv_query($this->conn, $query,array(), array("Scrollable"=>"buffered"));
		if(!$result){
